...
class ThreeD60(data.Dataset):
    ...
    def __init__(self, root_dir, list_file, height, width, augment_color, augment_flip, augment_rotation, repeat, is_training=False, **kwargs):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        inputs["raw_rgb"] = aug_rgb.clone()
        inputs["strong_rgb"] = inputs["raw_rgb"].clone() 
